...
test -d target || mvn install:install-file -DgroupId=com.mcdermottroe.apple -DartifactId=osx-keychain -Dversion=0.1.4 -Dpackaging=jar -Dfile=lib/osxkeychain-0.1.4.jar -DgeneratePom=true
