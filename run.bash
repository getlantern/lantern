...
#pushd ..
test -d target || mvn install:install-file -DgroupId=org.eclipse.swt.cocoa -DartifactId=x86 -Dversion=3.7.1 -Dpackaging=jar -Dfile=lib/swt-3.7.1-cocoa-macosx.jar -DgeneratePom=true
test -d target || mvn install:install-file -DgroupId=org.eclipse.swt.cocoa -DartifactId=x86_64 -Dversion=3.7.1 -Dpackaging=jar -Dfile=lib/swt-3.7.1-cocoa-macosx-x86_64.jar -DgeneratePom=true
test -d target || mvn install:install-file -DgroupId=org.eclipse.swt.win32.win32 -DartifactId=x86 -Dversion=3.7.1 -Dpackaging=jar -Dfile=lib/swt-3.7.1-win32-win32-x86.jar -DgeneratePom=true
test -d target || mvn install:install-file -DgroupId=org.eclipse.swt.gtk.linux -DartifactId=x86 -Dversion=3.7.1 -Dpackaging=jar -Dfile=lib/swt-3.7.1-gtk-linux-x86.jar -DgeneratePom=true
test -d target || mvn install:install-file -DgroupId=org.eclipse.swt.gtk.linux -DartifactId=x86_64 -Dversion=3.7.1 -Dpackaging=jar -Dfile=lib/swt-3.7.1-gtk-linux-x86_64.jar -DgeneratePom=true
...
test -d target || mvn install:install-file -DgroupId=com.mcdermottroe.apple -DartifactId=osx-keychain -Dversion=0.1.5 -Dpackaging=jar -Dfile=lib/osxkeychain-0.1.5.jar -DgeneratePom=true
