...
linux-release: clean linux pubget gen
	...
	flutter_distributor package --flutter-build-args="--verbose $(DART_DEFINE)" --platform linux --targets "deb,rpm" --skip-clean
...
windows-release: clean windows pubget gen
	flutter_distributor package --flutter-build-args="--verbose $(DART_DEFINE)" --platform windows --targets "exe"
