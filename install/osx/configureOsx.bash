...
osascript -e "do shell script \"chown root:admin $APP_PATH/Contents/Resources/app/configureNetworkServices\" with administrator privileges" || die "Could not change owner"
