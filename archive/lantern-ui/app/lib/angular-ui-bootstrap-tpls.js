 ...
 */
  .factory('$position', ['$document', '$window', function ($document, $window) {
    ...
    return {
       ...
       */
      positionElements: function (hostEl, targetEl, positionStr, appendToBody, $position) {
        ...
        compile: function (tElem, tAttrs) {
          ...
          return function link ( scope, element, attrs ) {
            ...
            var positionTooltip = function () {
              ...
              var ttPosition = $position.positionElements(element, tooltip, ttScope.placement, appendToBody, $position);
              ttPosition.top += 'px';
              ttPosition.left += 'px';
