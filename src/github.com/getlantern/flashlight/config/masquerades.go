...
var cloudflareMasquerades = []*fronted.Masquerade{
	...
	&fronted.Masquerade{
		Domain:    "tert.am",
		IpAddress: "162.159.251.131",
	},
	&fronted.Masquerade{
		Domain:    "tgju.org",
		IpAddress: "141.101.126.99",
	},
	&fronted.Masquerade{
