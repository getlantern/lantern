// Package defaultmasquerades contains the default masquerades for lantern
package defaultmasquerades
...
var Cloudflare = []*fronted.Masquerade{}

var Cloudfront = []*fronted.Masquerade{
	&fronted.Masquerade{
