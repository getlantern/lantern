...
// replace github.com/getlago get ntern/lantern-server-provisioner => ../lantern-server-provisioner
...
require (
	...
	github.com/getlantern/radiance v0.0.0-20251118105138-b6e64bfda19e
