...
// Pin qpack to v0.5.1 — sagernet/quic-go (v0.52.0-sing-box-mod.3) needs the
// v0.5.1 API, but quic-go/quic-go v0.59.0 keeps v0.6.0 in the require graph
// via MVS. This replace is what forces v0.5.1 at build time, so the v0.6.0
// entry in the require block below is expected — it reflects MVS resolution,
// not the actual version linked. Matches the replace in radiance and
// lantern-box.
...
require (
	...
	github.com/getlantern/radiance v0.0.0-20260421194126-97ff9acf203e
...
require (
	...
	github.com/getlantern/lantern-box v0.0.70 // indirect
