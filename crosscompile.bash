...
# Compile for Mac
gox -ldflags="-w -X main.version $VERSION -X main.buildDate $BUILD_DATE" -osarch="darwin/amd64" github.com/getlantern/flashlight
# Compile for Windows (use -H=windowsgui ldflag to make this a Windows instead of a console app)
gox -ldflags="-w -X main.version $VERSION -X main.buildDate $BUILD_DATE -H=windowsgui" -osarch="windows/386" github.com/getlantern/flashlight
