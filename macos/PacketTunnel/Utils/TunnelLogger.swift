...
class TunnelLogger {
    private let generalLog = OSLog(subsystem: "org.getlantern.lantern.PacketTunnel", category: "General")
    private let networkLog = OSLog(subsystem: "org.getlantern.lantern.PacketTunnel", category: "Networking")
