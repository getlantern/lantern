      ...
      return {
        ...
        link: function link ( scope, element, attrs ) {
          ...
          function show() {
            ...
            // move if too close to bottom or right edge of window
            /*
            ttPosition.top -= Math.max(0, ttHeight - ($window.innerHeight - ttPosition.top));
            ttPosition.left -= Math.max(0, ttWidth - ($window.innerWidth - ttPosition.left));
            */
