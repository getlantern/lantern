...
angular.module('app.i18n', [])
  ...
  .constant('TRANSLATIONS', {
    ...
    en: {
      ...
      SOMEONE_I_KNOW_INFO: 'Your contact will receive a message immediately notifying them of your request.',
      ...
      REQUEST_SENT_PROMPT: 'Your request has been sent. You will receive an email when you have been invited. Lantern will continue in demo mode in the meantime.',
      FIRST_INVITE_RECEIVED_TITLE: 'Invitation Received',
      FIRST_INVITE_RECEIVED_INTRO: 'You have received an invitation to connect on Lantern.',
