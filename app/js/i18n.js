...
angular.module('app.i18n', [])
  ...
  .constant('TRANSLATIONS', {
    ...
    en: {
      ...
      PROXIED_SITES_PROMPT: 'By default, only sites on this list will be accessed (“proxied”) through your Lantern network. All other sites are accessed directly. Only going through Lantern when necessary is stealthier and more efficient.',
      SEARCH: 'Search',
      ...
      FINISHED_PROMPT_GIVE: 'Your connection is now ready to be shared through your Lantern social network. Thank you for running Lantern!',
      FINISHED_PROMPT_GET: 'You will now be able to access your proxied sites through your Lantern social network. Thank you for running Lantern!',
