...
angular.module('app.i18n', [])
  ...
  .constant('TRANSLATIONS', {
    ...
    fa: {
      ...
      AUTHORIZE_TIP_GTALK: 'Lantern works best with a large network of users who trust one another to share internet connections. Signing in through Google allows you to connect to users in your network, and not just anyone.',
      EMAIL_USE: 'Your email address is kept private within your Lantern social network and only ever used to send you important Lantern notifications.',
