...
public class SystemTrayImpl implements SystemTray
    ...
    public void createTray()
        ...
        // menu bar on OSX.
        if (SystemUtils.isJavaVersionAtLeast(1.6f) && NativeUtils.supportsTray()) 
            {
            ...
            final File iconFile;
            final File iconCandidate1 =
                new File ("src/main/resources/mg_16x16.png");
            ...
            try
                {
                image = Toolkit.getDefaultToolkit().getImage(iconFile.toURI().toURL());
                }
            ...
            NativeUtils.addTray(image, "MG", popup);
            } 
        else 
            {
