...
run_system_extension_preflight() {
  ...
  case "$exit_code" in
    0)
      ...
      ;;
    20)
      printf 'System extension approval is missing on this runner. Approve Lantern once in System Settings, or install the MDM approval profile, then rerun this smoke test.\n' >&2
      ;;
    21)
