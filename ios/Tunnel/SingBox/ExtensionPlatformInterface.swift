...
public class ExtensionPlatformInterface: NSObject, UtilsPlatformInterfaceProtocol
{
  ...
  // includeAllNetworks is set at the VPN profile level in Profile.swift instead,
  // which forces iOS to route all traffic through the tunnel without affecting
  // the TUN stack choice. See getlantern/engineering#3133.
