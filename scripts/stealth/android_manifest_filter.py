...
# De-branded REAL component classes (generated by debrand_kotlin.py: package
# org.getlantern.lantern -> foundation.bridge, brand class names Lantern -> Backend).
STEALTH_APPLICATION_NAME = "foundation.bridge.BackendApp"
STEALTH_ACTIVITY_NAME = "foundation.bridge.MainActivity"
STEALTH_VPN_SERVICE_NAME = "foundation.bridge.service.BackendVpnService"
STEALTH_TILE_SERVICE_NAME = "foundation.bridge.service.QuickTileService"
# Neutral name (no "Vpn"): debrand_kotlin renames NoVpnLanternService ->
# LocalConnectionService so the stealth no-VPN artifact's manifest component and
