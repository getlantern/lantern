...
---
أداة التحايل على الرقابة &#34;Censorship circumvention&#34; متاحة للتنزيل على أي نظام تشغيل
...
- 📱 إن كان متجر التطبيقات غير متاح في منطقتك، بإمكانك اتباع [هذه الخطوات] (https://lantern.io/faq#use-2) لتنزيل أداة Lantern.
