        ...
        locations: json["locations"] == null
            ...
            : Map<String, Location_>.from(
                (json["locations"] as Map<String, dynamic>).map(
                  (k, v) => MapEntry(
                    k,
                    Location_.fromJson(v as Map<String, dynamic>)
                      ..tag = k
                      ..protocol = _protocolFromTag(k),
                  ),
                ),
              ),
...
/// Outbound tags generated by lantern-cloud are of the form
/// "<protocol>-out-<track>-<uuid>" (e.g. "reflex-out-reflex-linode-pro-...").
/// We derive the protocol from the first segment because the backend's
/// ServerLocation struct does not carry a Protocol field.
String _protocolFromTag(String tag) {
