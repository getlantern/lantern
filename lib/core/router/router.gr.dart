...
import 'package:lantern/features/home/new_home.dart' as _i9;
...
/// generated route for
/// [_i8.Logs]
class Logs extends _i15.PageRouteInfo<LogsArgs> {
  Logs({
    _i16.Key? key,
    List<_i15.PageRouteInfo>? children,
  }) : super(
          Logs.name,
          args: LogsArgs(key: key),
          initialChildren: children,
        );
  ...
  static _i15.PageInfo page = _i15.PageInfo(
    name,
    builder: (data) {
      final args = data.argsAs<LogsArgs>(orElse: () => const LogsArgs());
      return _i8.Logs(key: args.key);
    },
  );
}

class LogsArgs {
  const LogsArgs({this.key});

  final _i16.Key? key;

  @override
  String toString() {
    return 'LogsArgs{key: $key}';
  }
}

/// generated route for
/// [_i9.NewHome]
class NewHome extends _i15.PageRouteInfo<void> {
  const NewHome({List<_i15.PageRouteInfo>? children})
      : super(
          NewHome.name,
          initialChildren: children,
        );
