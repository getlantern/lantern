...
import 'package:lantern/core/models/server_location.dart' as _i45;
...
/// generated route for
/// [_i23.PrivateServerGCP]
class PrivateServerGCP extends _i41.PageRouteInfo<void> {
  const PrivateServerGCP({List<_i41.PageRouteInfo>? children})
  ...
  static _i41.PageInfo page = _i41.PageInfo(
    name,
    builder: (data) {
      return const _i23.PrivateServerGCP();
    },
  );
}
...
class PrivateServerDetailsArgs {
  ...
  @override
  int get hashCode => key.hashCode ^ const _i44.ListEquality().hash(accounts);
}
...
class ServerLocations extends _i41.PageRouteInfo<ServerLocationsArgs> {
  ServerLocations({
    ...
    required String title,
    required void Function(_i45.ServerLocation) onSelected,
    List<_i41.PageRouteInfo>? children,
  }) : super(
...
class ServerLocationsArgs {
  ...
  final void Function(_i45.ServerLocation) onSelected;
