...
class DefaultBypassLists extends _i30.PageRouteInfo<void> {
  const DefaultBypassLists({List<_i30.PageRouteInfo>? children})
      : super(
          DefaultBypassLists.name,
          initialChildren: children,
        );
