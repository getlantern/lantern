...
import 'package:lantern/core/models/server_location.dart' as _i47;
...
class DeployingServer extends _i42.PageRouteInfo<void> {
  const DeployingServer({List<_i42.PageRouteInfo>? children})
...
class DeviceLimitReachedArgs {
  ...
  bool operator ==(Object other) {
    ...
    return key == other.key &&
        const _i46.ListEquality().equals(devices, other.devices);
  }

  @override
  int get hashCode => key.hashCode ^ const _i46.ListEquality().hash(devices);
}
...
/// generated route for
/// [_i14.FollowUs]
class FollowUs extends _i42.PageRouteInfo<FollowUsArgs> {
  FollowUs({_i43.Key? key, List<_i42.PageRouteInfo>? children})
      : super(
          FollowUs.name,
...
/// generated route for
/// [_i15.Home]
class Home extends _i42.PageRouteInfo<HomeArgs> {
  Home({_i43.Key? key, List<_i42.PageRouteInfo>? children})
      : super(
          Home.name,
...
class JoinPrivateServerArgs {
  ...
  bool operator ==(Object other) {
    ...
    return key == other.key &&
        const _i46.MapEquality().equals(deepLinkData, other.deepLinkData);
  }

  @override
  int get hashCode =>
      key.hashCode ^ const _i46.MapEquality().hash(deepLinkData);
}
...
class ServerLocations extends _i42.PageRouteInfo<ServerLocationsArgs> {
  ServerLocations({
    ...
    required String title,
    required void Function(_i47.ServerLocation) onSelected,
    List<_i42.PageRouteInfo>? children,
  }) : super(
...
class ServerLocationsArgs {
  ...
  final void Function(_i47.ServerLocation) onSelected;
