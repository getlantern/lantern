...
import 'package:lantern/lantern/protos/protos/auth.pb.dart' as _i48;
...
class DeviceLimitReached extends _i45.PageRouteInfo<DeviceLimitReachedArgs> {
  DeviceLimitReached({
    _i46.Key? key,
    required List<_i48.UserResponse_Device> devices,
    List<_i45.PageRouteInfo>? children,
  }) : super(
...
class DeviceLimitReachedArgs {
  ...
  final List<_i48.UserResponse_Device> devices;
  ...
  bool operator ==(Object other) {
    ...
    return key == other.key &&
        const _i49.ListEquality<_i48.UserResponse_Device>().equals(
          devices,
          other.devices,
        );
  }
  ...
  int get hashCode =>
      key.hashCode ^
      const _i49.ListEquality<_i48.UserResponse_Device>().hash(devices);
}
...
class UnboundedScreen extends _i45.PageRouteInfo<void> {
  const UnboundedScreen({List<_i45.PageRouteInfo>? children})
