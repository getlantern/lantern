...
import 'package:lantern/lantern/protos/protos/auth.pb.dart' as _i43;
...
class DeviceLimitReached extends _i40.PageRouteInfo<DeviceLimitReachedArgs> {
  DeviceLimitReached({
    _i41.Key? key,
    required List<_i43.UserResponse_Device> devices,
    List<_i40.PageRouteInfo>? children,
  }) : super(
...
class DeviceLimitReachedArgs {
  ...
  final List<_i43.UserResponse_Device> devices;
  ...
  bool operator ==(Object other) {
    ...
    return key == other.key &&
        const _i44.ListEquality<_i43.UserResponse_Device>().equals(
          devices,
          other.devices,
        );
  }
  ...
  int get hashCode =>
      key.hashCode ^
      const _i44.ListEquality<_i43.UserResponse_Device>().hash(devices);
}
...
/// generated route for
/// [_i13.FollowUs]
class FollowUs extends _i40.PageRouteInfo<void> {
  const FollowUs({List<_i40.PageRouteInfo>? children})
...
class JoinPrivateServerArgs {
  ...
  bool operator ==(Object other) {
    ...
    return key == other.key &&
        const _i44.MapEquality<String, String>().equals(
          deepLinkData,
          other.deepLinkData,
        );
  }
  ...
  int get hashCode =>
      key.hashCode ^
      const _i44.MapEquality<String, String>().hash(deepLinkData);
}
...
class MacOSExtensionDialog extends _i40.PageRouteInfo<void> {
  const MacOSExtensionDialog({List<_i40.PageRouteInfo>? children})
...
class PrivateServerLocationArgs {
  ...
  bool operator ==(Object other) {
    ...
    return key == other.key &&
        const _i44.ListEquality<String>().equals(location, other.location) &&
  ...
  int get hashCode =>
      key.hashCode ^
      const _i44.ListEquality<String>().hash(location) ^
...
class PrivateServerDetails
  ...
  static _i40.PageInfo page = _i40.PageInfo(
    ...
    builder: (data) {
      ...
      return _i26.PrivateSeverDetails(
        key: args.key,
...
class PrivateServerDetailsArgs {
  ...
  bool operator ==(Object other) {
    ...
    return key == other.key &&
        const _i44.ListEquality<String>().equals(accounts, other.accounts) &&
        provider == other.provider &&
  ...
  int get hashCode =>
      key.hashCode ^
      const _i44.ListEquality<String>().hash(accounts) ^
      provider.hashCode ^
