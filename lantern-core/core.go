...
type App interface {
	...
	ReferralAttachment(ctx context.Context, referralCode string) (bool, error)
}
...
func (lc *LanternCore) ReferralAttachment(ctx context.Context, referralCode string) (bool, error) {
