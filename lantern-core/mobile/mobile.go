...
func DeleteAccount(email, password string, oAuthProvider bool) ([]byte, error) {
	return withCoreR(func(c lanterncore.Core) ([]byte, error) { return c.DeleteAccount(email, password, oAuthProvider) })
}
