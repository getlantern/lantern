...
func TestParseIssueType(t *testing.T) {
	for s, want := range map[string]issue.IssueType{
		...
		"split_tunnel":                 issue.SplitTunnel,
		"smart_routing_not_working":    issue.SmartRouting,
		"server_selection_not_working": issue.ServerSelection,
		"upgrade_fail":                 issue.UpgradeFail,
		"other":                        issue.Other,
		"Slow":                         issue.Slow,
